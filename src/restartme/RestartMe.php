...
class RestartMe extends PluginBase{
    ...
    public function onEnable(){
        ...
        $this->getScheduler()->scheduleRepeatingTask(new AutoBroadcastTask($this), ($this->getConfig()->get("broadcastInterval") * 20));
        if($this->getConfig()->get("restartOnOverload")){
            $this->getScheduler()->scheduleRepeatingTask(new CheckMemoryTask($this), 6000);
        ...
        $this->getScheduler()->scheduleRepeatingTask(new RestartServerTask($this), 20);
